...
namespace GProtobuf.Benchmark
{
    ...
    public class GProtobufBench
    {
        ...
        public byte[] emptyBytes = new byte[12801];
        ...
        [Benchmark(Description = "Empty Serialize")]
        [BenchmarkCategory("Serialization")]
        public void SerializeEmpty()
        {
            ...
            for (int i = 0; i < 128; i++)
            {
                ms.Write(this.emptyBytes, 0, 100);
                //ms.WriteByte(this.emptyBytes[i]);
            }
            //ms.Write(this.emptyBytes, 0, emptyBytes.Length);
            //Model.Serialization.Serializers.SerializeBenchmarkModel(ms, TestModel);
        }
