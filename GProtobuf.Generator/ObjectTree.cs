...
class ObjectTree
{
    ...
    private void GenerateCode(StringBuilderWithIndent sb, KeyValuePair<string, List<TypeDefinition>> namespaceWithObjects, string nmspace)
    {
        sb.Clear();
        ...
        foreach (var obj in objects)
        {
            ...
            if (obj.ProtoIncludes != null && obj.ProtoIncludes.Count > 0)
            {
                ...
                foreach (var include in obj.ProtoIncludes)
                {
                    ...
                    sb.IncreaseIndent();
                    sb.AppendIndentedLine($"Serialize{className}(stream, obj1);");
    ...
    private void WriteProtoMemberSerializer(StringBuilderWithIndent sb, ProtoMemberAttribute protoMember)
    {
        ...
        switch (typeName)
        {
            ...
            case "Double":
            case "double":
                sb.AppendIndentedLine($"writer.WriteTag({protoMember.FieldId}, WireType.Fixed64);");
