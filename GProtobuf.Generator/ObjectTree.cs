...
class ObjectTree
{
    ...
    {
        AddType(nmspace, new TypeDefinition(isStruct, isAbstract, IsEnum: false, fullName, protoIncludes, protoMembers, HasParameterlessConstructor: true, TypeSymbol: null, BaseClass: null));
    }
