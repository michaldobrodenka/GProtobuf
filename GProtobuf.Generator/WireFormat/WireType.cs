namespace GProtobuf.Generator.WireFormat
{
    ...
    ///
    /// IMPORTANT: This enum must remain identical to GProtobuf.Core.WireType for wire-format compatibility.
    /// Changes to this enum must be synchronized with Core/WireType.cs.
    /// </remarks>
